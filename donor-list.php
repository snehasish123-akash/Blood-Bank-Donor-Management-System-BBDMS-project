...
<link href="//fonts.googleapis.com/css?family=Montserrat:300,400,500,700&amp;subset=latin-ext" rel="stylesheet">
...
<body>
    ...
    <div class="agileits-contact py-5">
        <div class="py-xl-5 py-lg-3">
            ...
            <div class="d-flex">
                <div class="row package-grids mt-5" style="padding-left: 10px;">
                    <?php
                    $status = 1;
                    ...
                    if ($query->rowCount() > 0) {
                        foreach ($results as $result) { ?>
                            <div class="col-md-4 pricing">
                                ...
                                <div class="price-bottom p-4" style="font-size: 14px;">
